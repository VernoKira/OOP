...
public class Test {
	...
	public static void main(String[] args) throws IOException, CreditLimit, ClassNotFoundException {
...
//		String name, int credits, String courseCode
		...
		Book book1 = new Book(Genre.DETECTIVE,"A1","First","1BK",2008);
		Book book2 = new Book(Genre.DRAMA,"A2","Second","2BK",1999);
		Book book3 = new Book(Genre.FICTION,"A3","Third","3BK",2015);
		Book book4 = new Book(Genre.SCIENCE,"A4","Fourth","4BK",2007);
		Book book5 = new Book(Genre.SCIENCE,"A5","Fifth","5BK",2003);
		Book book6 = new Book(Genre.DETECTIVE,"A6","Sixth","6BK",2017);
		
		
		CourseFiles courseFile1 = new CourseFiles("Final sample",teacher1,course1);
		...
		Database.courseFile.add(courseFile1);
		Database.save();
		Database.read();
					...
					if (u instanceof Student) {
						...
						while(flag) {
							...
							switch(number) {
								...
								case 6:
									...
									String courseID12 = reader.readLine();
									System.out.println(st.viewAttendance(courseID12));
									break;
								case 7:
								...
								case 11:
									...
									break;
								case 12:
									System.out.println(st.viewOwnCourses());
									break;
								case 13:
									System.out.println("Enter book ID, librarian ID: ");
									String bkID = reader.readLine();
									String lbID = reader.readLine();
									st.orderBook(bkID, lbID);
									Database.save();
									break;
								case 14:
									System.out.println(st.viewBook());
									break;
								case 0:
									System.exit(0);
							}
						...
						while(flag) {
							...
							case 14:
								...
								break;
							case 15:
								System.out.println("Enter teacher ID, Course Code: ");
								String studentID15 = reader.readLine();
								String courseCode15 = reader.readLine();
								if (m.addStudentToCourse(studentID15, courseCode15)) {
						...
						while(flag) {
							...
							case 2:
								...
								ad.addStudent(StudentName, StudentSurname, studentID, pws, f, g,new Adress(city,country,street), dg, year);
