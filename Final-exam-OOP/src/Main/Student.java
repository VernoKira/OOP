...
public class Student extends User{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6794010087762038288L;
...
//------------------------------------------------------------------------------------------------------------------------	
    /**
     * here student can rate teachers
     */
	...
	public String viewTranscript() {
		String str = "";
		for (Entry<Course, Mark> m : this.getMarks().entrySet()) {
	 ...
	 */
	public String viewAttendance(String courseCode) {
		for (User usr: Database.users) {
    		if (usr instanceof Student) {
    			Student std = (Student)usr;
    			if (std.getId().equals(this.getId())) {
